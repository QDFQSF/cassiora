...
const boxes = [
  ...
  { id: "petit-dejeuner", nom: "Petit Déjeuner", description: "Le cake change toutes les semaines (citron ou marbré). Chouquettes selon la taille choisie.", contenu: ["Brioche au sucre 1/pers", "Brioche pépite de chocolat 1/pers", "Chouquettes (quantités variables)", "Madeleine 1/pers", "Mini Cake 1/pers"], tarifs: { "2/3": 25, "4/6": 50, "8/10": 85 }, highlight: false },
  { id: "brunch", nom: "Le Brunch de Cassiora", description: "Le brunch complet sucré-salé. Topping inclus (pâte à tartiner, caramel ou confiture au choix).", contenu: ["Brioche sucre + chocolat 1/pers", "Brioche perdue 1/pers", "Pancakes 1/pers", "Mini cake sucré 1/pers", "Chouquettes", "Mini quiche 1/pers", "Mini cake salé 1/pers", "Petits feuilletés salés 1/pers", "Brochette de fruits frais 1/pers", "1 pot de topping au choix"], tarifs: { "2/3": 55, "4/6": 100, "8/10": 150 }, highlight: true },
