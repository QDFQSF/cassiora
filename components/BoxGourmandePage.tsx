...
const boxes = [
  { id: "pause-sucree", nom: "La Pause Sucrée", description: "Collections permanentes, retrouvez tous les mois dans votre box un gâteau/biscuit en plus.", contenu: ["Cookies 1/pers", "Muffins pépite de chocolat 1/pers", "Brownie 1/pers", "Donuts au sucre 1/pers", "+ Gâteau du mois 1/pers"], tarifs: { "2/3": 1, "4/6": 42, "8/10": 70 }, highlight: false },
  ...
  { id: "fromage", nom: "Plateau de Fromage", description: "Sélection selon saison. Confiture/chutney + fruits et fruits secs compris. Pain non inclus.", contenu: ["Brie · Tomme de brebis · Bleu", "Cantal · Comté · Tomme du Ramier · Chèvre", "2/3 pers : 3 variétés", "4/6 pers : 5 variétés", "8/10 pers : 7 variétés"], tarifs: { "2/3": 26, "4/6": 45, "8/10": 75 }, highlight: false },
  { id: "charcuterie", nom: "Plateau de Charcuterie", description: "Beurre + cornichons + fruits et légumes frais compris. Pain non inclus.", contenu: ["Jambon cru · Jambon blanc · Rosette", "Coppa · Chorizo · Saucisse sèche", "Terrine de campagne · Mousse de foie"], tarifs: { "2/3": 28, "4/6": 48, "8/10": 85 }, highlight: false },
  { id: "alliance", nom: "L'Alliance Gourmande", description: "Sélection mixte fromages & charcuteries. Beurre + cornichons + fruits compris. Pain non inclus.", contenu: ["2/3 : 2 fromages + 2 charcuteries", "4/6 : 3 fromages + 4 charcuteries", "8/10 : 5 fromages + 6 charcuteries", "Beurre doux ou demi-sel au choix", "Cornichons + fruits & légumes frais"], tarifs: { "2/3": 32, "4/6": 56, "8/10": 90 }, highlight: false },
];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {boxes.map((box) => {
              ...
              return (
                <div key={box.id} className="card-luxury p-7 flex flex-col relative" style={box.highlight ? { borderColor: "rgba(201,168,76,0.5)" } : {}}>
                  {box.highlight && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 text-black text-[0.55rem] tracking-[0.2em] uppercase whitespace-nowrap" style={{ fontFamily: "'Cinzel', serif", background: "linear-gradient(135deg, #c9a84c, #e2ce75)" }}>Le plus populaire</div>
                  )}
                  <div className="mb-4">
